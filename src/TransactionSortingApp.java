...
public class TransactionSortingApp {
    ...
    static void printList(String msg, List<Transaction> list) {
    ...
    public static void main(String[] args) {
        ...
        printList("Input Transactions:", transactions);

        ArrayList<Transaction> bubbleList = new ArrayList<>(transactions);
        bubbleSort(bubbleList);
        printList("Bubble Sorted (by fee):", bubbleList);

        ArrayList<Transaction> insertionList = new ArrayList<>(transactions);
        insertionSort(insertionList);
        printList("Insertion Sorted (fee + timestamp):", insertionList);
